    ...
    <div className="min-h-screen bg-white dark:bg-[#0B0B0F]">
      ...
      <section className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            {/* Main Heading */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-[#F1F5F9] mb-6 leading-tight">
            ...
            {/* Subtitle */}
            <p className="text-xl sm:text-2xl text-gray-600 dark:text-[#94A3B8] mb-12 max-w-4xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <Link
                to="/auth"
                className="px-8 py-4 rounded-full bg-gradient-to-r from-[#9945FF] to-[#14F195] text-white font-semibold text-lg hover:opacity-90 transition-opacity duration-200 flex items-center space-x-2 shadow-lg"
              >
              ...
              <Link
                to="/registry"
                className="px-8 py-4 rounded-full border-2 border-gray-300 dark:border-[#1E293B] text-gray-900 dark:text-[#F1F5F9] font-semibold text-lg hover:bg-gray-50 dark:hover:bg-[#1E293B] transition-colors duration-200"
              >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-[#9945FF] to-[#14F195] flex items-center justify-center">
              ...
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-[#14F195] to-[#00FFFF] flex items-center justify-center">
              ...
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-[#9945FF] to-[#00FFFF] flex items-center justify-center">
              ...
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-[#14F195] to-[#9945FF] flex items-center justify-center">
      ...
      <section className="py-20 bg-gray-50 dark:bg-[#111827]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-[#0B0B0F] p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-[#1E293B] hover:shadow-xl transition-shadow duration-300">
      ...
      <section className="py-20 bg-gradient-to-r from-[#9945FF] via-[#14F195] to-[#00FFFF]">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <Link
            to="/auth"
            className="inline-flex items-center px-8 py-4 rounded-full bg-white text-[#9945FF] font-semibold text-lg hover:bg-gray-100 transition-colors duration-200 shadow-lg"
          >
